  ...
  <div class="menu-bar">
      <transition name="slide-up">
        <div class="menu-wrapper" :class="{'hide-box-shadow':isSettingShow || !ifTitleAndMenuShow}" v-show="ifTitleAndMenuShow">
          ...
          <div class="icon-wrapper">
            <div class="icon-light icon" @click="showSetting(1)"></div>
          </div>
          <div class="icon-wrapper">
            <div class="icon-progress icon" @click="showSetting(2)"></div>
          </div>
          <div class="icon-wrapper">
            <div class="icon" @click="showSetting(0)">A</div>
          </div>
        </div>
      </transition>
       <transition name="slide-up">
        <div class="setting-wrapper" v-show="isSettingShow">
          ...
          <div class="setting-theme" v-if="showTag==1" >
            <div class="setting-theme-item" v-for="(item,index) in themeList" :key="index" :class="{'no-border':item.style.body.background!=='#fff'}" @click="setTheme(index)">
          ...
          <div class="setting-progress" v-if="showTag==2">
            <div class="progress-wrapper">
              ...
              @change="onProgressChange($event.target.value)" @input="onProgressInput($event.target.value)" :value="progress"
      ...
      <content-view @jumpTo="jumpTo" :bookAvailable="bookAvailable" :navigation="navigation" v-show="ifShowContent" :ifShowContent="ifShowContent">
...
export default {
  ...
  methods:{
    ...
    onProgressInput(progress) {
      ...
      this.$refs.progress.style.backgroundSize= `${this.progress}%`
    },
